...
const state = { filter: "all", sort: "popular", cart: [] };
...
checkoutBtn.addEventListener("click", () => alert("Demo checkout — integrate Razorpay/Stripe or COD."));
...
function prettyCat(cat){
  const map = { sarees:"Sarees", lehengas:"Lehengas", kurtas:"Kurtas & Suits", girls:"Girls", accessories:"Accessories" };
  return map[cat] || cat;
}
